        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('mobils.update', $mobil) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="mb-4">
                                <label for="merek" class="block text-sm font-medium text-gray-700">Merek</label>
                                <input type="text" name="merek" id="merek" value="{{ old('merek', $mobil->merek) }}"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="harga" id="harga" value="{{ old('harga', $mobil->harga) }}" min="0" step="1000"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" name="kapasitas_mesin" id="kapasitas_mesin" value="{{ old('kapasitas_mesin', $mobil->kapasitas_mesin) }}" min="1"
                            ...
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700">Jenis Mobil Saat Ini</label>
                                <div class="mt-1 p-3 bg-gray-50 rounded-md">
                                    <p class="text-sm text-gray-900 font-medium">{{ $mobil->jenisMobil->nama_jenis }}</p>
                                    <p class="text-xs text-gray-500 mt-1">
                                        Jenis akan diperbarui otomatis jika kapasitas mesin diubah
                                    </p>
                                </div>
                            </div>
                        </div>
